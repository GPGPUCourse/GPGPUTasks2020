...
int main(int argc, char **argv)
{
...

    {
        ...
        for (int iter = 0; iter < benchmarkingIters; ++iter) {
            // TODO
            unsigned int work_group_size = 16;//sqrt
            ...
            matrix_multiplication_kernel.exec(gpu::WorkSize(16,16,global_work_size_x,global_work_size_y), as_gpu, bs_gpu, cs_gpu, M, K, N);
