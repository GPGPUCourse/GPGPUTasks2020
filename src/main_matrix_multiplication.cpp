...
//    /*
...

    {
        ...
        for (int iter = 0; iter < benchmarkingIters; ++iter) {
            ...
            unsigned int global_work_size_x = work_group_size_x * ((M + work_group_size_x - 1) / work_group_size_x);
            unsigned int global_work_size_y = work_group_size_y * ((K + work_group_size_y - 1) / work_group_size_y);
            matrix_multiplication_kernel.exec(gpu::WorkSize(work_group_size_x, work_group_size_y, global_work_size_x, global_work_size_y),
