...
int main()
{
    ...
    for (int platformIndex = 0; platformIndex < platformsCount; ++platformIndex) {
        ...
        size_t platformVendorsSize = 0;
        OCL_SAFE_CALL(clGetPlatformInfo(platform, CL_PLATFORM_VENDOR, 0, nullptr, &platformVendorsSize));

        std::vector<unsigned char> platformVendors(platformVendorsSize, 0);
        OCL_SAFE_CALL(clGetPlatformInfo(platform, CL_PLATFORM_VENDOR, platformVendorsSize, platformVendors.data(), nullptr));
        std::cout << "    Platform vendor: " << platformVendors.data() << std::endl;
        ...
        for (int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex) {
            ...
            std::cout << "        Device memory size: " << deviceMem / 1024 / 1024 << "MB" << std::endl;
