...
__kernel void mandelbrot(__global float *results,
    ...
    if (smoothing == 1 && iter != iters) {
        // TODO ну да я просто скопировал с кпу, вообще довольно очевидно как делать, но мне кажется вариант
        //  с большим ифом плохой и это должен быть отдельный кернел
